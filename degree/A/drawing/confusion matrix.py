...
plt.figure(None,(24,10),300)

#标签名称
labels_name = ['bridge','commercial', 'dense','industrial',
                'lake','meadow','medium',
               'overpass',  'parking','railway',
               'river','roundabout','spare']

validation_dir = '/home/tx-lab/dingyue/A/train'
# D:\A\train   /home/tx-lab/dingyue/A/train
...
model = load_model('/home/tx-lab/city-planning/degree/A/models/Multichannel2M.h5')
#D:\workspace\python_project\A\models\Multichannel2M.h5
# /home/tx-lab/city-planning/degree/A/models/Multichannel1M.h5
#输出准确率和损失值
