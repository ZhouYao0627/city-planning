...
fr1 = open('/home/tx-lab/city-planning/A/history/VGG16.txt', 'r')
dic1 = eval(fr1.read())   #读取的str转换为字典
print(dic1)
fr1.close()

fr3 = open('/home/tx-lab/city-planning/degree/A/history/FGR-AM.txt', 'r')
dic3 = eval(fr3.read())   #读取的str转换为字典
print(dic3)
fr3.close()

fr5 = open('/home/tx-lab/city-planning/A/history/LW-CNN.txt', 'r')
