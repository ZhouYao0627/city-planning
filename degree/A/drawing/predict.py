...
#标签名称
labels_name = ['bridge','commercial_area', 'dense_residential','industrial_area',
                'lake','meadow','medium_residential',
               'overpass',  'parking_lot','railway_station',
               'river','roundabout','spare_residential']


validation_dir = '/home/tx-lab/dingyue/predict/600'
...
model = load_model('/home/tx-lab/city-planning/A/models/LW-CNNV1.h5')
#输出准确率和损失值
